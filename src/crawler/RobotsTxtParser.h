 ...
 */
[[nodiscard]] std::optional<std::string_view> tryMatchStartGroupLine(std::string_view line) noexcept;
...
public:
  ...
  [[nodiscard]] RuleType type() const noexcept { return m_type; }

  [[nodiscard]] const std::string& path() const noexcept { return m_path; }

  [[nodiscard]] bool hasEol() const noexcept { return m_hasEol; }

  /**
   * Returns the position of the wildcard in the rule if exists or -1 otherwise
   */
  [[nodiscard]] int wildCardPos() const noexcept { return m_wildCardPos; }
 ...
 *   string_view rule
 */
[[nodiscard]] std::optional<Rule> tryParseRule(std::string_view line) noexcept;
